    ...
    <>
          ...
          <div className="grid items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-3xl text-base leading-relaxed text-slate-600 dark:text-slate-300">
                ...
                elegante y servicio profesional para crear espacios funcionales y
      ...
      <MotionSection delayMs={120}>
        <section className="container-custom grid gap-6 pb-20 md:grid-cols-2">
          ...
          <article className="interactive-card rounded-2xl border border-slate-200 bg-white p-6 md:col-span-2 dark:border-slate-800 dark:bg-slate-900">
            <h2 className="text-2xl font-semibold text-slate-900 dark:text-white">
