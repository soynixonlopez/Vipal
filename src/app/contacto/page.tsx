          ...
          <aside className="space-y-5">
            <article className="interactive-card rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="mt-5 inline-flex items-center gap-2 rounded-xl bg-[#0a5f80] px-4 py-2 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-[#084c66]"
              >
                <svg
                  viewBox="0 0 32 32"
                  aria-hidden="true"
